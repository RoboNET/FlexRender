...
- **Rich content types** -- text, images, QR codes, barcodes, separators
...
| Template expressions | `{{variable}}`, dot notation, array indexing |
...
| [[Template-Syntax]] | Canvas, all 8 element types, common properties, units |
| [[Element-Reference]] | Complete property reference for all 8 element types with examples |
...
- [`AGENTS.md`](../../AGENTS.md) -- build commands, coding conventions, contributor guidelines
