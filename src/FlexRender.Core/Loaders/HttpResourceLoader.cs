...
public sealed class HttpResourceLoader : IResourceLoader, IDisposable
{
    ...
    /// Use <c>false</c> when the client is provided by <see cref="System.Net.Http.IHttpClientFactory"/>.
    /// </param>
    ...
    /// in the constructor). Clients provided by <see cref="System.Net.Http.IHttpClientFactory"/>
