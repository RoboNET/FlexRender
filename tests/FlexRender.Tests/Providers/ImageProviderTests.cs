...
public sealed class ImageProviderTests : IDisposable
{
    ...
    public void Generate_FromFile_LoadsImage()
    {
        ...
        using var bitmap = ImageProvider.Generate(element);
    ...
    {
        Assert.Throws<ArgumentNullException>(() => ImageProvider.Generate(null!));
    }
    ...
    public void Generate_EmptySource_ThrowsArgumentException()
    {
        ...
        Assert.Throws<ArgumentException>(() => ImageProvider.Generate(element));
    }
    ...
    public void Generate_NonExistentFile_ThrowsFileNotFoundException()
    {
        ...
        Assert.Throws<FileNotFoundException>(() => ImageProvider.Generate(element));
    }
    ...
    public void Generate_WithCacheHit_UsesCachedBitmap()
    {
        ...
        using var result = ImageProvider.Generate(element, cache);
    ...
    public void Generate_WithNoCache_UsesInlineLoading()
    {
        ...
        using var result = ImageProvider.Generate(element);
